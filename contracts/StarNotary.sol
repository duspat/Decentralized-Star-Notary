...
contract StarNotary is ERC721 {
    ...
    string public constant name = "Star Gazer";
    ...
    function lookUptokenIdToStarInfocreateStar(string memory _name, uint256 _tokenId) public { // Passing the name and tokenId as a parameters
